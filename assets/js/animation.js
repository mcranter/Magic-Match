...
/*eslint no-unused-vars: "error"*/
  ...
  checkForCardMatch(card) {
    ...
    { this.cardMatch(card, this.cardToCheck); } else this.cardMismatch(card, this.cardToCheck);
...
function ready() {
  ...
  const game = new mixer(100, cards);
...
const Music = document.getElementById('bgmuzak');
function playPause() {
